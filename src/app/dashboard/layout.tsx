...
export default function DashboardLayout({
  ...
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset className="relative min-h-screen bg-[#282830]">
        {/* Decoration Images */}
        ...
        <div className="relative z-3 m-4 h-full w-full rounded-[2rem] border-3 border-[#EEEFF6] bg-[#EEEFF614] p-8">
